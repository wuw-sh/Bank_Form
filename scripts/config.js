export const config = {
    ...
    forms: {
        bankMenu: {
            title: '§l§aธนาคาร',
            body: (money, bank) => `เงินสด§e: §a${money} §fบาท\n§fเงินในธนาคาร§e: §a${bank} §fบาท\n\n`,
            buttons: {
                deposit: {
                    text: '§l§aฝากเงิน',
        ...
        deposit: {
            ...
            send: {
                success: {
                    deposit: (value) => `§l§fคุณได้ §aฝากเงิน§f เข้าธนาคาร ทั้งหมด§e: §a${value} §fบาท`
                },
                wrongs: {
                    ...
                    moneyNotEnough: (value) => `§l§eเงินสด §cของคุณไม่เพียงพอ ขาดอีก§e: §a${value} §fบาท`
                }
            }
        },
        withdraw: {
            ...
            send: {
                success: {
                    withdraw: (value) => `§l§fคุณได้ §eถอนเงิน§f ออกจากธนาคาร ทั้งหมด§e: §a${value} §fบาท`
                },
                wrongs: {
                    isEmpty: '§l§cกรุณาใส่จำนวนเงินที่ต้องการถอน',
                    notNumber: '§l§cกรุณาใส่จำนวนเงินเป็นตัวเลข',
                    amountLess: '§l§cกรุณาใส่จำนวนเงินที่มากกว่า §f0 §cบาท',
                    bankNotEnough: (value) => `§l§aเงินในธนาคาร §cของคุณไม่เพียงพอ ขาดอีก§e: §a${value} §fบาท`
                }
            }
        },
        transfer: {
            ...
            dropdown: {
                ...
                options: {
                    ...
                    listPlayer: (index, listpayeename, listpayeebank) => `§a#§e${index} §f${listpayeename} §e(§a${listpayeebank} §fบาท§e)`
                },
                defaultValueIndex: ''
            },
            input: {
            ...
            send: {
                success: {
                    giverTransfer: (payeeName, value, wish) => `§l§fคุณได้ §bโอนเงิน §fให้ §e@${payeeName}\n §e-§fจำนวน§7: §r§a${value} §fบาท\n §l§e-§fคำอวยพร§7: §r§f${wish}`,
                    payeeTransfer: (giverName, value, wish) => `§l§fคุณได้รับเงินจาก §e@${giverName}\n §e-§fจำนวน§7: §r§a${value} §fบาท\n §l§e-§fคำอวยพร§7: §r§f${wish}`
                },
                wrong: {
